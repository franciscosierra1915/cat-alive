...
function App() {
  ...
  // useEffect(() => {
  //   console.log(petfinderAPIKEY);
  //   console.log(petfinderAPISECRET);
  // });
  ...
  const adoptCat = (catToBeAdopted) => {
    if (currentUser !== null) {
      ...
      fetch("http://localhost:3000/cats", objectConfig)
        .then((res) => res.json())
        .then((newAdoptedCat) =>
          setUserCats((userCats) => [...userCats, newAdoptedCat])
        );
          ...
          <AnimatePresence initial={false} exitBeforeEnter>
            <Switch location={location} key={location.pathname}>
              ...
              <Route
                exact
                path="/profile"
                render={() => <Profile imageDetails={imageDetails} />}
              />
              <Route
                exact
                path="/cat-alive"
              ...
              <Route
                ...
                render={() => (
                  <CatList
                    ...
                    cats={cats}
                    redirectHome={redirectHome}
                    displaySingleCat={displaySingleCat}
                  />
                )}
              />
              <Route
                ...
                render={() => (
                  <MyCatList
                    currentUser={currentUser}
                    cats={
                      userCats ? userCats.filter((cat) => cat.adopted) : null
                    }
                    redirectHome={redirectHome}
                    displayMySingleCat={displayMySingleCat}
                  />
                )}
              />
              <Route
                ...
                render={() => (
                  <MyFosterList
                    currentUser={currentUser}
                    cats={
                      userCats ? userCats.filter((cat) => cat.fostered) : null
                    }
                    redirectHome={redirectHome}
                    displayMySingleCat={displayMySingleCat}
                  />
              ...
              <Route
                ...
                render={() => (
                  <SearchOrganizations
                    getShelterZip={(e) => getShelterZip(e)}
                  />
                )}
              />
              <Route
                ...
                render={() => (
                  <Hamburger
                    redirectHome={redirectHome}
                    shelters={shelters}
                    displaySingleShelter={displaySingleShelter}
                  />
                )}
              />
              <Route
                exact
                path="/single-shelter"
                render={() => <SingleShelter shelter={clickedSingleShelter} />}
              />
            </Switch>
          </AnimatePresence>
        )}
